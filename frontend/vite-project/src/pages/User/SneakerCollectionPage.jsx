...
const SneakerCollectionPage = () => {
  ...
  useEffect(() => {
    axios
      .get(`${API_URL}/api/products?category=sneakers`, {
        headers: {
    ...
    <div>
      <div className="flex flex-col lg:flex-row ">
        ...
        <div className="flex-grow p-4">
          <h1 className="text-2xl uppercase font-semibold">Sneakers Collection</h1>
...
export default SneakerCollectionPage;